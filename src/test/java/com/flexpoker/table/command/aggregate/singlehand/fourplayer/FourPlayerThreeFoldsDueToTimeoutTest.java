...
public class FourPlayerThreeFoldsDueToTimeoutTest {
    ...
    public void test() {
        ...
        var rightOfButtonActionOnChangedEvent = (ActionOnChangedEvent) table.fetchNewEvents().get(4);
        table.expireActionOn(rightOfButtonActionOnChangedEvent.getHandId(),
                rightOfButtonActionOnChangedEvent.getPlayerId());

        var buttonActionOnChangedEvent = (ActionOnChangedEvent) table.fetchNewEvents().get(6);
        table.expireActionOn(buttonActionOnChangedEvent.getHandId(), buttonActionOnChangedEvent.getPlayerId());

        var smallBlindActionOnChangedEvent = (ActionOnChangedEvent) table.fetchNewEvents().get(8);
