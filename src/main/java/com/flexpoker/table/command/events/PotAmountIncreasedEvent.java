...
public class PotAmountIncreasedEvent extends BaseEvent<TableEventType> implements
        TableEvent {

    private static final TableEventType TYPE = TableEventType.PotAmountIncreased;
