...
class TableBalancer(private val gameId: UUID, private val maxPlayersPerTable: Int) {

    fun createSingleBalancingEvent(subjectTableId: UUID, pausedTablesForBalancing: Set<UUID>,
    ...
    private fun createEventToMoveUserFromSubjectTableToAnyMinTable(subjectTableId: UUID,
        tableToPlayersMap: Map<UUID, MutableSet<UUID>>, playerToChipsAtTableMap: Map<UUID, Int>
    ): Optional<GameEvent> {
    ...
    private fun getRequiredNumberOfTables(totalNumberOfPlayers: Int): Int {
